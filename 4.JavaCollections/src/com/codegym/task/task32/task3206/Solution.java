...
public class Solution {
    ...
    public  <T extends Item>T getProxy(Class<T> returnClass, Class... items) {
        ...
        return (T) Proxy.newProxyInstance(returnClass.getClassLoader(), interfaces.toArray(new Class[interfaces.size()]), new ItemInvocationHandler());
    }
